...
**`git add -A`** — prend tout, y compris ce que vous n'avez pas relu. Préférer nommer les chemins : `git add docs/03-justice/ static/pdf/lecons/03-justice/`.
...
| hlp27 | *bascule à venir* — hlp27.profauda.fr | hlp.profauda.fr |
| dgemc27 | *bascule à venir* — dgemc27.profauda.fr | dgemc.profauda.fr |
